...
function Level:init()
    ...
    -- define collision callbacks for our world; the World object expects four callbacks,
...
function Level:update(dt)
    ...
    for _, body in pairs(self.destroyedBodies) do
...
function Level:render()
    ...
    for x = -VIRTUAL_WIDTH, VIRTUAL_WIDTH * 2, 35 do
        love.graphics.draw(textures['tiles'], frames['tiles'][12], x, VIRTUAL_HEIGHT - 35)
    end
