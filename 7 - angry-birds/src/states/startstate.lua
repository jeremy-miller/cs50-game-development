...
function StartState:render()
    ...
    love.graphics.rectangle('fill', VIRTUAL_WIDTH / 2 - 205, VIRTUAL_HEIGHT / 2 - 40, 401, 108, 3)

    love.graphics.setColor(200/255, 200/255, 200/255, 1)
    love.graphics.setFont(fonts['huge'])
    love.graphics.printf('Angry Birds', 0, VIRTUAL_HEIGHT / 2 - 40, VIRTUAL_WIDTH, 'center')
