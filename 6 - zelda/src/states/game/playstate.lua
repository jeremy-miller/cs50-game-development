...
function PlayState:init()
    self.player = Player {
        ...
        health = 6, -- one heart == 2 health

        offsetY = 5 -- rendering and collision offset for spaced sprites
    }
...
function PlayState:render()
    ...
    for i = 1, 3 do
        ...
        love.graphics.draw(textures['hearts'], frames['hearts'][heartFrame], (i - 1) * (TILE_SIZE + 1), 2)
